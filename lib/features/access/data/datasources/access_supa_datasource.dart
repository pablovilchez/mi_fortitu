...
import 'package:mi_fortitu/features/access/data/models/db_login_model.dart';
import 'package:supabase_flutter/supabase_flutter.dart';

class AccessSupaDatasource {
  final SupabaseClient _supabase;

  AccessSupaDatasource(this._supabase);

  Future<Either<AccessException, DbLoginModel>> login(
    String email,
    String password,
  ) async {
    try {
  ...
  Future<Either<AccessException, DbLoginModel>> register(
    String email,
    String password,
  ) async {
    try {
